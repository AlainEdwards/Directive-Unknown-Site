...
<html>
  <head>
	...
	<meta name="keywords" content="html, css, php, server">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div id="confirmation">
        <h2> Success! </h2>
        <p>Thank you for your message <?php if (isset($_POST["name"])){echo $_POST["name"];}?>, we will get back to you as soon as possible regarding your message about <?php if (isset($_POST["subject"])){echo $_POST["subject"];}?> </p>
        <?php if(isset($_POST["phone"]) && !empty($_POST["phone"]))
				{echo "<p>Listen out for our phone call, we will reach you at " . $_POST["phone"] . "<br />or<br />";}
		?>
        <p> Look out for an email from us, we will email you at <?php if (isset($_POST["email"])){echo $_POST["email"];} ?> </p>
        <div class="btn-group btn-group-lg">
        <button type="button" class="btn btn-default" onClick="javascript:window.location.href='index.php'">Home</button>
        </div>
    	</div>
        </div>
    </div>
